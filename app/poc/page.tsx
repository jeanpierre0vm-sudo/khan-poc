    ...
    <main className="min-h-screen bg-gray-950 text-white font-sans">
      ...
      <header className="border-b border-gray-800 px-8 py-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-sm mt-0.5">An AI Video Processing Pipeline for PM Content Operations</p>
        </div>
      </header>
      ...
      <section className="px-8 py-14 border-b border-gray-800">
        <div className="max-w-6xl mx-auto">
          <p className="text-sm font-bold uppercase tracking-widest text-blue-400 mb-10">Proof of Concept</p>
      ...
      <section className="px-8 py-14 border-b border-gray-800">
        <div className="max-w-6xl mx-auto">
          <p className="text-sm font-bold uppercase tracking-widest text-blue-400 mb-3">Video Metadata Repository</p>
